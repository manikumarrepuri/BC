...
let Request     = require(appRootPath + "/lib/request");
let assert      = require("chai").assert;
let _           = require("itheon-utility").underscore;

let defaultLimit   = 50;
let defaultCount   = undefined;
let defaultStorage = "default";
...
describe("Request", function() {
  ...
  describe("passing object to appendConditions() method", function () {

    it("should allow passing other conditions", function () {
      ...
      request.appendConditions(appendedConditions);
    ...
    it("should NOT allow appending invalid conditions", function () {
      ...
      assert.throw(function() {
          request.appendConditions(appendedConditions)
        }, "Invalid list of values for field: 'xx'"
      );
    });
  });
});
