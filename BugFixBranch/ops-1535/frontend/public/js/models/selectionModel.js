 ...
 *
 * @source https://github.com/jtrussell/angular-selection-model
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        var updateDom = function() {
          if (!smItem) {
            console.warn("something gone wrong - unable to find selected row - probably it was deleted");
            return;
          }
