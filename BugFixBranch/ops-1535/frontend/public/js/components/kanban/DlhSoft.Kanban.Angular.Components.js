    ...
    (function (Controls) {
        ...
        (function (KanbanBoard) {
            ...
            function getItemsInGroupAndState(group, state) {
              ...
              //Not sure how these could be missing
              ...
              for (var i = 0; i < this.items.length; i++) {
                ...
                if (item.group.name === group.name && item.state.name === state.name) {
                  if(this.startDate) {
                ...
                return {
                    ...
                    controller: function ($scope) {
                        ...
                        if (!this.collapsedGroupHeight)
                            this.collapsedGroupHeight = 86;
                        if (!this.itemTemplateUrl)
                            this.itemTemplateUrl = '/static/js/components/kanban/DlhSoft.Kanban.Angular.Components.Templates/kanban-item.html';
                        if (!this.groupTemplateUrl)
                            this.groupTemplateUrl = '/static/js/components/kanban/DlhSoft.Kanban.Angular.Components.Templates/kanban-group.html';
                        if (!this.stateTemplateUrl)
                            this.stateTemplateUrl = '/static/js/components/kanban/DlhSoft.Kanban.Angular.Components.Templates/kanban-state.html';
                    ...
                    controllerAs: 'dskb',
                    templateUrl: '/static/js/components/kanban/DlhSoft.Kanban.Angular.Components.Templates/kanban-board.html'
                };
            })
